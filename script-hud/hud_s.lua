 ...
 --dxDrawRectangle(bg.x-(-480/zoom), bg.y-(535/zoom), w+(250/zoom), h+(250/zoom), tocolor(0,0,0,255))
 --dxDrawImage(bg.x-(-420/zoom), bg.y-(560/zoom), w, h-(-50/zoom), "i/Czapa.png", angle, 270, 0)
